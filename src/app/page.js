...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen flex flex-col items-center justify-center px-3 sm:px-6 sm:px-12 py-8">
      {/* Name and Intro */}
      <section className="fade-in flex items-center justify-around gap-2 w-full">
        ...
        <div className="">
          ...
          <h2 className="fade-in text-base sm:text-xl sm:text-xl text-gray-700 dark:text-white">
      ...
      <ul>
        ...
        <li className="fade-in mt-10 w-full">
          ...
          <ul className="mt-2 space-y-2 pl-4">
            ...
            <li className="transition hover:translate-x-2">🔹 created a <LinkButton href="https://flexor-front-end-2c6r.vercel.app/">social media platform</LinkButton> for fun.</li>
            {/* Project Nav */}
          </ul>
        </li>
        ...
        <li className="fade-in mt-10 w-full">
          ...
          <ul className="mt-2 space-y-2 pl-4">
            <li className="transition hover:translate-x-2">🌎 i am Korean by birth, but have lived in France, Singapore, Hong Kong, UK, and now the US.</li>
            <li className="transition hover:translate-x-2">🎭 i changed my major every year since started university.</li>
            <li className="transition hover:translate-x-2">🐩 i have an obsession with my <LinkButton href="https://drive.google.com/file/d/1-bqq4FrjviTp4diNt37gkz6cnVYWMXuf/view?usp=sharing">poodle</LinkButton> and miss him everyday :&#41;</li>
          </ul>
        </li>
      </ul>
    </div>

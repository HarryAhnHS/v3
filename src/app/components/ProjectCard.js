...
const ProjectCard = ({ project }) => {
  return (
    <div className="bg-neutral-100/50 dark:bg-neutral-800/50 rounded-2xl overflow-hidden transition-transform duration-300">
        <Image 
            src={project.image} 
        ...
        <div className="p-4">
            ...
            <div className="flex justify-between mt-4">
                ...
                <a href={project.demo} target="_blank" className="flex items-center gap-1 hover:text-gray-600 dark:hover:text-gray-300 transition-transform duration-300 hover:scale-110">
